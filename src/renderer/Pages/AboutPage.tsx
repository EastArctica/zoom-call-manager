    ...
    <div className="about-container">
      ...
      <div className="about-section">
        ...
        <ul className="feature-list">
          <li>
            Create and manage mapping rules between phone number patterns and
            Zoom phone numbers
          </li>
      ...
      <div className="about-section">
        ...
        <p className="section-description">
          Built with Electron and React, providing a smooth cross-platform
          experience.
        </p>
      </div>
      ...
      <div className="about-section">
        ...
        <p className="section-description">
          For support or feature requests, please contact your system
          administrator.
        </p>
      </div>
